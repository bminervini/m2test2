...
namespace Mailing;
    ...
    class MailSender
    {
        ...
        private function configureSMTP()
        {
            ...
            $this->m_oMailer->Username = $m_sLogin;     //< Login
            $this->m_oMailer->Password = $m_sPassword;  //< Password
        ...
        public function sendMail($oMail)
        {
            ...
            $this->m_oMailer->setFrom($oMail->getSender());
    ...
    // $ms->sendMail(new Mail("m2test2.croissant.show@gmail.com" , "yannis.beaux@gmail.com" , "Je suis un mail" , "Je suis un corps"));
