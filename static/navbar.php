	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="nav navbar">
			<div class="navbar-nav">
				...
				<a class="nav-item nav-link" href="GestionAdhesion.php" style="color:white">Gestion Des Demandes dadhesion</a>
				<a class="nav-item nav-link" href="GestionParticipants.php" style="color:white">Gestion des Participants</a>
				<!-- TODO: Disconnect -->
			...
			<div class="navbar-nav">
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li><button><span class="glyphicon glyphicon-ok"></span>  Je participe</button></li>
						<li><button><span class="glyphicon glyphicon-remove"></span>  Je ne participe pas<button></li>
					</ul>
				</div>
				<!-- TODO: Disconnect -->
				<a class="nav-item nav-link" href="login.php"><img src="i/shutdown.png" width="2%"></img></a>
